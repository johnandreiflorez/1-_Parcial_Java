...
public class servletPrueba extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // las variables corresponden al contenido a extraer
            ...
            out.println("<body>");
            num1 = Integer.parseInt(request.getParameter("txtPrimerNumero"));
            num2 = Integer.parseInt(request.getParameter("txtSegundoNumero"));
