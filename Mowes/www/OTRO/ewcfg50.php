...
define("EW_RANDOM_KEY", '0p&oMc#I9l%utQLq', TRUE); // Random key for encryption
...
// Security
define("EW_ADMIN_USER_NAME", "a", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "a", TRUE); // Administrator password
...
define("EW_SENDER_EMAIL", "ok", TRUE); // Sender email
