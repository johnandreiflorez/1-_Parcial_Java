...
class CtrRuta
{
		...
		function guardar()//este método es para insertar
		{
        ...
        function Listar()
        {
         ...
         //SE ASIGNA EN UNA POSICIÓN DESOCUPADA (EN ESTE CASO LA $mat[0][0], EL VALOR CON EL NÚMERO DE REGISTROS
          ...
          $i=0;
        // LA FUNCIÓN  mysql_fetch_array   PERMITE RECORRER EL RECORDSET (CURSOR A LA TABLA Ruta)
        ...
        function consultar()
        {
            ...
            //DEL OBJETO objRuta MEDIANTE EL MÉTODO setDescripcion
