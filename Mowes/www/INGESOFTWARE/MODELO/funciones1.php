...
function calendario(){
?>
     <link rel="stylesheet" type="text/css" href="CSS/carman_style.css">

     <table border="1" align="center"><tbody>
        <tr>
            <td colspan="3" width="140" nowrap="nowrap">Fecha de Reserva:</td>


            <td> <input type="text" name="enddate" Value="yyyy-mm-dd" size="15">
           	</td>
            <td><input type="button" value="..." onclick='displayDatePicker("enddate")' >  </td>
	...
	var dayArray = new Array('Do', 'Lu', 'Ma', 'Mie', 'Ju', 'Vi', 'Sa');
	var monthArray = new Array('Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun', 'Jul', 'Ago', 'Sept', 'Oct', 'Nov', 'Dic');
...
href="index.php_files/carman_style.cs">
<?
}
?>