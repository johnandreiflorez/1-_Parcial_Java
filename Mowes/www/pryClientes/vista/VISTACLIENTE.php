...
include("../control/CtrConexion.php");
 ...
 try{
   ...
   if($boton =="consultar"){
             ...
             echo  "el número de teléfonos de ". $nomCliente." es = ". $tam. "<br>";
    }
 }
   catch (Exception $exp)
   {
...
<tr>
<td style=\"width: 161px;\">IDENTIFICACIÓN</td>
<td style=\"width: 608px;\"><input name=\"txtId\"></td>
</tr>
<tr>
<td style=\"width: 161px;\">DIRECCIÓN</td>
<td style=\"width: 608px;\"><input size=\"90\" name=\"txtDir\"></td>
</tr>
<tr>
<td style=\"width: 161px;\">TELÉFONOS</td>
...
<td style=\"width: 608px;\"><input name=\"chkDeporte\" type=\"checkbox\">Deportes <input name=\"chkLiteratura\" type=\"checkbox\">Literatura <input name=\"chkTecnologia\" type=\"checkbox\">Tecnología <input name=\"chkMusica\" type=\"checkbox\">Música <input name=\"chkCine\" type=\"checkbox\">Cine <br>
<input name=\"chkOtro\" type=\"checkbox\">Otro
cuál? <input name=\"txtCual\"><br>
</td>
</tr>
<tr>
