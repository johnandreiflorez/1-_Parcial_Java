<?
	...
	var $recordSet;
        ...
        */
        ...
        $consulta="insert into usuarios values('".$nomUsuario."','".$contrasena."')";
	...
	$this->recordSet=$recordSet;
        ...
        $consulta="update usuarios set contrasena='".$contrasena."' where usuario ='".$nomUsuario."'";
         echo " Comando SQL : ". $consulta;
		$recordSet=$ObjConexion->ejecutarSql($bd,$consulta);
         $ObjConexion->cerrar($enlace);
		//--------------VERIFICAMOS SI SE REALIZO LA CONSULTA--------------------------------------------------
	...
	$this->recordSet=$recordSet;
        ...
        $consulta="delete from usuarios where usuario ='".$nomUsuario."'";
         echo " Comando SQL : ". $consulta;
		$recordSet=$ObjConexion->ejecutarSql($bd,$consulta);
         $ObjConexion->cerrar($enlace);
		//--------------VERIFICAMOS SI SE REALIZO LA CONSULTA--------------------------------------------------
	...
	$this->recordSet=$recordSet;
        ...
        $consulta="select * from usuarios where usuario ='".$nomUsuario."'";
